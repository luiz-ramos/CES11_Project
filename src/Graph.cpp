...
GameLevels::GameLevels() {
    ...
    // Level 1
    Level first;
    first.enemies->emplace_back(0, 0, 0, 100, 100);

    this->levelsVector->push_back(first);
    // Level 2
    Level second;
    second.enemies->emplace_back(0,0,0,100,100);
    second.enemies->emplace_back(0,0,0,100,600);

    this->levelsVector->push_back(second);
    // Level 3
    Level third;
    third.enemies->emplace_back(0,0,0,100,100);
    third.enemies->emplace_back(0,0,0,100,600);
    third.enemies->emplace_back(0,0,0,500,600);

    this->levelsVector->push_back(third);
    // Level 4
    Level fourth;
    fourth.enemies->emplace_back(0,0,0,100,100);
    fourth.enemies->emplace_back(0,0,0,100,600);
    fourth.enemies->emplace_back(0,0,0,500,600);
    fourth.enemies->emplace_back(0,0,0,500,100);

    this->levelsVector->push_back(fourth);
    // Level 5
    Level fifth;
    fifth.enemies->emplace_back(1,0,0,300,100);

    this->levelsVector->push_back(fifth);
}
