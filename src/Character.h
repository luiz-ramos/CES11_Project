...
public:
    ...
    void upgrade(int HPUp = 0, int damageUp = 0, int bulletSpeedUp = 0, int charSpeedUp = 0);
    void updateGun(sf::Vector2f target);
    void fireGun(std::vector<std::shared_ptr<sf::Sprite>> * bullets);
